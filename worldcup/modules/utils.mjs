...
export const WORLD_CUP_CLIP_REUSE_COOLDOWN_VIDEOS = Math.max(0, Math.min(4, Number(process.env.WORLD_CUP_CLIP_REUSE_COOLDOWN_VIDEOS || 3) || 3));
...
export const WORLD_CUP_ENABLE_WIKIMEDIA_VISUALS = normalizeBool(process.env.WORLD_CUP_ENABLE_WIKIMEDIA_VISUALS, false);
export const WORLD_CUP_ENABLE_LOCAL_ENTITY_ASSETS = normalizeBool(process.env.WORLD_CUP_ENABLE_LOCAL_ENTITY_ASSETS, true);
export const WORLD_CUP_LOCAL_ENTITY_OVERLAY_SCREEN_RATIO = Math.max(0.65, Math.min(0.78, Number(process.env.WORLD_CUP_LOCAL_ENTITY_OVERLAY_SCREEN_RATIO || 0.72) || 0.72));
...
export const WORLD_CUP_RESEARCH_MODE = cleanText(process.env.WORLD_CUP_RESEARCH_MODE || "scrape").toLowerCase();
export const WORLD_CUP_SCRAPE_MAX_PAGES = Math.max(2, Math.min(12, Number(process.env.WORLD_CUP_SCRAPE_MAX_PAGES || 6) || 6));
export const WORLD_CUP_SCRAPE_SEARCH_RESULTS = Math.max(3, Math.min(15, Number(process.env.WORLD_CUP_SCRAPE_SEARCH_RESULTS || 8) || 8));
